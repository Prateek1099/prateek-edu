      ...
      <Card className="w-full max-w-md shadow-lg border-primary/10">
        ...
        <CardContent className="grid gap-4">
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="w-full col-span-2 shadow-sm" type="button" onClick={handleLogin}>
        ...
        <CardFooter className="flex flex-col text-sm text-muted-foreground text-center space-y-2">
          ...
          <p className="text-xs max-w-sm mx-auto">
             Note: Authentication is currently running in stub mode until Firebase credentials are configured in `.env.local`
          </p>
        </CardFooter>
      </Card>
    </div>
